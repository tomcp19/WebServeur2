...
ActiveRecord::Schema.define(version: 2020_09_07_151457) do
  ...
  create_table "joueurs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["partie_id"], name: "index_joueurs_on_partie_id"
  end
  ...
  create_table "parties", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "joueur_id"
    t.index ["joueur_id"], name: "index_parties_on_joueur_id"
  end

  add_foreign_key "joueurs", "parties", column: "partie_id"
  add_foreign_key "parties", "joueurs"
end
